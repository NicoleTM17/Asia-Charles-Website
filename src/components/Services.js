  ...
  return(
    <div id='services'>
      ...
      <div className='services-details' style={{backgroundImage: 'linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5)), url(images/services-background1.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', color:'var(--licorice-black-color)'}}>
        ...
        <br/><br/>
        <h2 className='services-header' style={{fontSize: '2em', fontWeight: 'bold', marginBottom: '.5em'}}>Personalised guided meditations</h2>
        ...
        <br/>
        <h2 className='services-subheader' style={{fontSize: '2em', fontWeight: '200'}}>My approach</h2>
      ...
      <div className='how-it-works'>
        <h2 className='services-subheader' style={{fontSize: '2em', fontWeight: '200', marginBottom: '.5em'}}>How it works - Personalised guided meditations</h2>
    ...
    <div className='services-details' style={{backgroundImage: 'linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5)), url(images/services-background2.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', color:'var(--licorice-black-color)'}}>
      <h2 className='services-header' style={{fontSize: '2em', fontWeight: 'bold', marginBottom: '.5em'}}>Live guided meditations</h2>
      ...
      <div className='how-it-works'>
        <h2 className='services-subheader' style={{fontSize: '2em', fontWeight: '200', marginBottom: '.5em'}}>How it works - Live guided meditations</h2>
    ...
    <div className='services-details' style={{backgroundImage: 'linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5)), url(images/services-background3.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', color:'var(--licorice-black-color)'}}>
      <h2 className='services-header' style={{fontSize: '2em', fontWeight: 'bold', marginBottom: '.5em'}}>Mindfulness and Well-being workshops</h2>
    ...
    <div className='how-it-works'>
        <h2 className='services-subheader' style={{fontSize: '2em', fontWeight: '200', marginBottom: '.5em'}}>How it works - Mindfulness and Well-being workshops</h2>
    ...
    <div className='services-details' style={{backgroundImage: 'linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5)), url(images/services-background4.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', color:'var(--licorice-black-color)'}}>
      <h2 className='services-header' style={{fontSize: '2em', fontWeight: 'bold', marginBottom: '.5em'}}>Mindfulness and Well-being sessions</h2>
      <p>I run 1:1 mindfulness and well-being* sessions for adults.</p>
      <p>I teach you any of the topics listed <u>above</u>, including mindfulness-based tools and techniques to support you in developing resilience, cultivating joy, presence, and peace, and gaining a deeper understanding of yourself.</p>
    ...
    <div className='how-it-works'>
        <h2 className='services-subheader' style={{fontSize: '2em', fontWeight: '200', marginBottom: '.5em'}}>How it works - Mindfulness and Well-being sessions</h2>
