    ...
    <div id='about'>
      ...
      <div className='about-me'>
        ...
        <div className='about-text'>
          <h1 className='welcome-txt'><span style={{fontSize: '3.5em'}}>W</span><span className='move-txt' style={{marginLeft: '-0.5em'}}>elcome, I'm Asia</span></h1>
          ...
          <div className='services-btn'>Check out my services</div>
        </div>
